    ...
    return (
        <div className='relative'>
            ...
            <div className="inset-0 p-4">
                <button onClick={prev} className='absolute left-0 top-[50%] p-1 rounded-full shadow bg-white/80 text-gray-800 hover:bg-white'>
                    <ChevronLeft />
                </button>
                <button onClick={next} className='absolute right-0 top-[50%] p-1 rounded-full shadow bg-white/80 text-gray-800 hover:bg-white'>
                    <ChevronRight />
                </button>
            </div>
